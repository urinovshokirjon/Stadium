package uz.urinov.stadium.sms.service;
...
import uz.urinov.stadium.telegram.SmsSenderTelegram;
...
public class SmsService {
    ...
    @Autowired
    private SmsSenderTelegram smsSenderTelegram;
...
//        send(phone, message);
    ...
    private void sendTelegram(String phone, String message) {
        smsSenderTelegram.sendConfirmSmsCode(phone, message);

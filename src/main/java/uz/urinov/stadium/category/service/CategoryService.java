package uz.urinov.stadium.category.service;
...
import uz.urinov.stadium.category.entity.CategoryEntity;
import uz.urinov.stadium.category.mapper.CategoryMapper;
import uz.urinov.stadium.category.repository.CategoryRepository;
...
public class CategoryService {
    ...
    // 5. Category By Lang
    public List<CategoryResponseDto> getCategoryByLang(Language lang) {
    ...
    // 5. Category By Lang
    public List<CategoryResponseDto> getCategoryByLang2(Language lang) {
    ...
    public CategoryResponseDto getCategory(Integer id, Language lang) {
        CategoryEntity categoryEntity = getCategoryEntityById(id);
